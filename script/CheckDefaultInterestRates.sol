...
contract CheckDefaultInterestRateModel is Script {
    ...
    function run() external view {
        ...
        console2.log("Interest rate at 40%%  = (%d, %d)", strategy.calculateInterestRates(0.4e18).supplyRate, strategy.calculateInterestRates(0.4e18).borrowRate);
        ...
        console2.log("Interest rate at 93%%  = (%d, %d)", strategy.calculateInterestRates(0.93e18).supplyRate, strategy.calculateInterestRates(0.93e18).borrowRate);
