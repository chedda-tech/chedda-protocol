...
contract VEChedda is ReentrancyGuard, Pausable, Ownable {
    ...
    Point[1000000000000000000] public pointHistory; // epoch -> unsigned point
    ...
    uint256 public constant MAXTIME = 2 * 365 * 86400; // 2 years
